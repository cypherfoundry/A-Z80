...
# A-Z80: A conceptual implementation of the Z80 CPU
...
-  "basic_de1" contains a simplified board consisting of A-Z80 CPU, memory and UART modules that can run small Z80 programs on Altera DE1
